...
def pgd_attack(models, input_image, accelerator, target_tensor, weight_dtype=torch.float16, num_steps=1, instance_prompt='a picture', gradient_accumulation_steps=1, alpha=0.005, eps=8.0/255.0):
